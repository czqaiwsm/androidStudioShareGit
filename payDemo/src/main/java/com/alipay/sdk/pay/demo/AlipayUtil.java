...
public class AlipayUtil {
   ...
   private String orderNo;
    ...
    public AlipayUtil (Activity activity,String orderNo,String subject, String body, String price,PayCallBack payCallBack){
...
//        orderInfo += "&notify_url=" + "\"" + "http://notify.msp.hk/notify.htm" + "\"";
        orderInfo += "&notify_url=" + "\"" + AlipayConstant.NOTIFY_URL + "\"";
